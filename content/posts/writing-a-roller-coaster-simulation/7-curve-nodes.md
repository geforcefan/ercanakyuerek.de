...
{{< iframe src="writing-a-roller-coaster-simulation/curve-nodes-binary-search.html" width="100%" height="200px" description="As you move the slider, you request a distance along the track. You can immediately see between which two nodes that distance is sandwiched." >}}
...
{{< iframe src="writing-a-roller-coaster-simulation/curve-nodes-motion-evaluation.html" width="100%" height="300px" description="Move the control points around to get a feeling for building a roller coaster track with physics motion." >}}

# Demo code

{{< show-script-code "/posts/writing-a-roller-coaster-simulation/CurveNodesMotionEvaluationScene.tsx" >}}
