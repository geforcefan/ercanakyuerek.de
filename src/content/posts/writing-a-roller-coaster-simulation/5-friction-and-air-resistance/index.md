...
with a single `matrixAtDis[FrictionAndAirResistanceDemoScene.tsx](FrictionAndAirResistanceDemoScene.tsx)tance` function. Working with **matrices** is more convenient, because we can extract everything we need from them.
